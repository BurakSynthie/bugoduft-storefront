const de = {
  nav: { home:'Startseite', products:'Produkte', scents:'Düfte', industries:'Branchen',
  ...
  cookie: { title:'Datenschutzeinstellungen',
    ...
    all:'Alle akzeptieren', necessary:'Nur notwendige', settings:'Einstellungen' },
  footer: { products:'Produkte', service:'Service', company:'Unternehmen', legal:'Rechtliches',
            orderStatus:'Bestellstatus', shipping:'Versand & Zahlung', about:'Über uns', b2b:'B2B',
            large:'Großbestellungen', imprint:'Impressum', privacy:'Datenschutz', terms:'AGB',
            withdrawal:'Widerrufsbelehrung', cookies:'Cookie-Einstellungen',
