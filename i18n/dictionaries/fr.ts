const fr = {
  nav: { home:'Accueil', products:'Produits', scents:'Parfums', industries:'Secteurs',
  ...
  cookie: { title:'Paramètres de confidentialité',
    ...
    all:'Tout accepter', necessary:'Nécessaires uniquement', settings:'Paramètres' },
  footer: { products:'Produits', service:'Service', company:'Entreprise', legal:'Mentions légales',
            orderStatus:'Suivi de commande', shipping:'Livraison & paiement', about:'À propos', b2b:'B2B',
            large:'Grandes commandes', imprint:'Mentions légales', privacy:'Confidentialité', terms:'CGV',
            withdrawal:'Droit de rétractation', cookies:'Cookies',
