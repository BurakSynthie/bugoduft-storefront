const en = {
  nav: { home:'Home', products:'Products', scents:'Scents', industries:'Industries',
  ...
  cookie: { title:'Privacy settings',
    ...
    all:'Accept all', necessary:'Necessary only', settings:'Settings' },
  footer: { products:'Products', service:'Service', company:'Company', legal:'Legal',
            orderStatus:'Order status', shipping:'Shipping & payment', about:'About', b2b:'B2B',
            large:'Large orders', imprint:'Imprint', privacy:'Privacy', terms:'Terms',
            withdrawal:'Right of withdrawal', cookies:'Cookie settings',
