...
export function Collections({ locale, dict, cols, sec }: { locale:Locale; dict:Dict; cols:Col[]; sec?:HomeSections }) {
  const x = sec ?? HOME_SECTIONS[locale];
  return (
...
export function HowItWorks({ locale, content, sec }: { locale:Locale; content:HomeContent; sec?:HomeSections }) {
  const x = sec ?? HOME_SECTIONS[locale];
  return (
...
export function ConfiguratorTeaser({ locale, dict, sec }: { locale:Locale; dict:Dict; sec?:HomeSections }) {
  const x = sec ?? HOME_SECTIONS[locale];
  return (
...
export function Pricing({ locale, cols, dict, sec }: { locale:Locale; cols:Col[]; dict:Dict; sec?:HomeSections }) {
  const x = sec ?? HOME_SECTIONS[locale];
  return (
...
export function FinalCta({ locale, dict, content, sec }: { locale:Locale; dict:Dict; content:HomeContent; sec?:HomeSections }) {
  const f = { title: sec?.ctaTitle ?? content.finalCta.title, body: sec?.ctaBody ?? content.finalCta.body };
  return (
