...
export async function actSetStatus(id:string, status:OpStatus, force=false){ await requireAdmin(); const r=await updateOpStatus(id,status,force); revalidatePath(`/admin/siparisler/${id}`); return r; }
